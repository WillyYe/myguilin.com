// myguilin.com — PRODUCTION (live) verification
// Real-browser checks against the deployed site (https://myguilin.com).
...
const PROD_URL = process.env.PROD_URL || 'https://myguilin.com/';
const SAME_ORIGIN = 'myguilin.com';
...
console.log('\n===== myguilin PRODUCTION — Live Verification =====');
