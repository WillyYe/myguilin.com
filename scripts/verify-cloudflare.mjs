#!/usr/bin/env node
// Verify Cloudflare (or any edge) security + cache response headers for myguilin.com.
// Usage: node scripts/verify-cloudflare.mjs  (override BASE_URL=https://myguilin.com)

const BASE = (process.env.BASE_URL || "https://myguilin.com").replace(/\/$/, "");
